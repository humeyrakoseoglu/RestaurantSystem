...
public class EventAdapter extends ArrayAdapter<String> {
    ...
    EventAdapter (Context c, int[]imgs,List<String> date,List<String> title,List<String> description){
        super(c,R.layout.custom,R.id.custom_title,title);
        this.context=c;
        this.date=date;
        this.title=title;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ImageView images = custom.findViewById(R.id.custom_event_image);
        TextView myTitle = custom.findViewById(R.id.custom_title);
        TextView myDescription = custom.findViewById(R.id.custom_description);
